...
//		resultString.append("\n\n== Additional Measurements"+note+"\n\n" + MLUtils.hashMapToString(vals,3));
	...
	*/
	 ...
	 */
	public static HashMap<String,Object> getStats(Result r, String vop, String evaluationType) {
		if (r.getInfo("Type").startsWith("MT"))
			return MLEvalUtils.getMTStats(r.allPredictions(),r.allTrueValues(), vop);
		else 
			return MLEvalUtils.getMLStats(r.allPredictions(), r.allTrueValues(), r.getInfo("Threshold"), vop, evaluationType);
	}
