...
import meka.classifiers.multilabel.LabelTransformationClassifier;
...
public class MLCBMaD extends LabelTransformationClassifier implements TechnicalInformationHandler {
	...
	OptionUtils.add(result, "tshd", getThreshold());
	...
	setThreshold(OptionUtils.parse(options, "tshd", getDefaultThreshold()));
