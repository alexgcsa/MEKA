...
public class MCC extends CC implements TechnicalInformationHandler, MultiTargetCapable {
	...
	protected String m_Payoff = "Exact-match-test";
	...
	public double payoff(CC h, Instances D) throws Exception {
		...
		r.output = Result.getStats(r, "7", "test");
                Double returnPayoff = (Double)r.getMeasurement(m_Payoff);
                
                if (returnPayoff == null){
                    returnPayoff = 0.0;
                }
		return returnPayoff;
	}
...
//					if (getDebug()) System.out.println("y' = "+Arrays.toString(y_)+", :"+w_);
	...
	public void setOptions(String[] options) throws Exception {
		...
		setPayoff(OptionUtils.parse(options, 'P', "Exact-match-test"));
