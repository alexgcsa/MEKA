 ...
 */
public class MinorityLabelset extends AbstractMultiLabelClassifier implements MultiTargetClassifier {
	...
	public String globalInfo() {
		return "Majority Labelset Classifier: Always predict the combination of labels which occurs least frequently in the training set.";
	}
	...
	public static void main(String args[]) {
		AbstractMultiLabelClassifier.evaluation(new MinorityLabelset(), args);
	}
