...
public class DBM extends RBM {
	 ...
	 */
	public DBM(int e, int h, double m, double r) throws Exception {
...
//		super.setOptions(options);
	...
	*/
	 ...
	 * @param	N	number of hidden layers - RBMs
	 */
	...
	*/
	...
	public double train(double X_[][], int batchSize) throws Exception {
		...
		for(int i = 0; i < N; i++) {
			rbm[i] = new RBM(this.m_E, this.m_H, this.MOMENTUM, this.LEARNING_RATE); // same options as this instantiation
