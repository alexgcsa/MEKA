...
public class RBM {
	...
	public RBM() {
        ...
        public RBM(int e, int h, double m, double r) throws Exception {
...
//		super.setOptions(options);
	...
	public void setOptions(String[] options) throws Exception {
		...
		try {
			...
			setH(Integer.parseInt(Utils.getOption("H_dbpnn",options)));
			setE(Integer.parseInt(Utils.getOption("E_dbpnn",options)));
			setLearningRate(Double.parseDouble(Utils.getOption("R_dbpnn",options)));
			setMomentum(Double.parseDouble(Utils.getOption("M_dbpnn",options)));
		} catch(Exception e) {
